    ...
    <div>
      ...
      <div className={`custom-sidebar ${expanded ? 'expanded' : ''} z-2`}>
        <Nav defaultActiveKey="/student/home" className="flex-column">
          <Nav.Item>
            <Link to="/student/home" className="nav-link custom-nav-link" onClick={() => setExpanded(false)}>
          ...
          <Nav.Item>
            <Link to="/student/announcements" className="nav-link custom-nav-link" onClick={() => setExpanded(false)}>
              <div className="d-flex align-items-center">
          ...
          <Nav.Item>
            <Link to="/student/companies" className="nav-link custom-nav-link" onClick={() => setExpanded(false)}>
              <div className="d-flex align-items-center">
          ...
          <Nav.Item>
            <Link to="/student/files" className="nav-link custom-nav-link" onClick={() => setExpanded(false)}>
              <div className="d-flex align-items-center">
          ...
          <Nav.Item>
            <Link to="/student/progress-reports" className="nav-link custom-nav-link" onClick={() => setExpanded(false)}>
              <div className="d-flex align-items-center">
          ...
          <Nav.Item>
            <Link to="/student/emergency-reports" className="nav-link custom-nav-link" onClick={() => setExpanded(false)}>
              <div className="d-flex align-items-center">
