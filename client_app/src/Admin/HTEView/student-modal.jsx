...
import { Mail, Phone, Calendar, Building2, CheckCircle, XCircle, Image as ImageIcon } from "lucide-react";
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <InfoItem
                  icon={Mail}
                  label="Company Email"
                  value={student.companyEmail}
                />
                <InfoItem
                  icon={Phone}
                  label="Company Phone"
                  value={student.companyPhone}
                />
                <InfoItem
                  icon={Building2}
