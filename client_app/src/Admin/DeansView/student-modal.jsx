...
import { Mail, Phone, Calendar, GraduationCap, Building2, CheckCircle, XCircle, Image as ImageIcon } from "lucide-react";
      ...
      <DialogContent className="sm:max-w-[600px] max-h-[80vh] overflow-y-auto">
        ...
        <DialogFooter className="gap-2 mt-6">
          ...
          <Button
            ...
            onClick={async () => {
              setLoading(true);
              await onApprove(student.userID);
              setLoading(false);
            }}
            disabled={loading}
          >
