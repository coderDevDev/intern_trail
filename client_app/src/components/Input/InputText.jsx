...
const MyTextInput = ({
  ...
  let controlClassName = [
    'px-3 py-2 max-w-full border-2 border-gray-700 rounded w-full dark:placeholder-gray-400',
  ...
  //console.log({ touched: meta.touched, error: meta.error, controlClassName })
