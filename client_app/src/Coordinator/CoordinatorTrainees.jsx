...
function CoordinatorTrainees() {
  ...
  return (
    <div>
      ...
      <ActionsModal open={isActionsModalOpen} onClose={handleActionsClose} />
      <ContactModal open={isContactModalOpen} onClose={handleContactClose} contactData={selectedStudent} />
